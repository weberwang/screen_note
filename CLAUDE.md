...
This project is indexed by GitNexus as **screen_note** (1218 symbols, 2384 relationships, 29 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
