    ...
    _WidgetSnapshot(
      ...
      items:
          (json['items'] as List<dynamic>?)
              ?.map(
                (e) => WidgetSnapshotItem.fromJson(e as Map<String, dynamic>),
              )
              .toList() ??
          const <WidgetSnapshotItem>[],
      hasPrivateContent: json['hasPrivateContent'] as bool? ?? false,
      hasFallbackContent: json['hasFallbackContent'] as bool? ?? false,
