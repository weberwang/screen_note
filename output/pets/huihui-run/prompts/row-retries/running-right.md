Create Codex pet row `running-right` for `huihui`: exactly 8 full-body frames in one horizontal strip on flat pure cyan #00FFFF.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: 写实毛绒风英短灰猫，圆脸，厚实短毛，偏金黄色圆眼，深灰鼻头，身体敦实，表情亲人灵动，动作带轻微键盘互动感，不加穿戴配件，保持真实猫比例和毛绒质感。. Preserve silhouette, face, palette, material, proportions, markings, and props.
