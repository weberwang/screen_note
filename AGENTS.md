...
- 任何新增目录或模块都应优先贴合项目既定分层：`app/`、`shared/`、`features/<feature>/`；业务模块统一收口到 `lib/features`，避免回退到平铺顶层业务目录。
...
This project is indexed by GitNexus as **screen_note** (1876 symbols, 3981 relationships, 114 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
