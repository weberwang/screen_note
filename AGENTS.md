...
This project is indexed by GitNexus as **screen_note** (895 symbols, 1130 relationships, 9 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
