...
This project is indexed by GitNexus as **screen_note** (2307 symbols, 4828 relationships, 83 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
